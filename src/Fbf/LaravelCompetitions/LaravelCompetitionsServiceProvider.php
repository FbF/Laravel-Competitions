...
class LaravelCompetitionsServiceProvider extends ServiceProvider {
	...
	{
		$this->package('fbf/laravel-competitions');

		if (\Config::get('laravel-competitions::routes.use_package_routes', true))
		{
